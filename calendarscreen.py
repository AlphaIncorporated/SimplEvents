...
def calendarScreen(self):
    ...
    #Calendar Title
    calendartitle = Label(calendarframe, text = "Calendar", font = ("Ariel, 50"))
    ...
    calendardayslabelmonday = Label(calendarframe, text = 'Monday', font = ("Ariel, 30"))
    calendardayslabelmonday.grid(row = 2, column = 0)
    calendardayslabeltuesday = Label(calendarframe, text = 'Tuesday', font = ("Ariel, 30"))
    calendardayslabeltuesday.grid(row = 2, column = 1)
    calendardayslabelwednesday = Label(calendarframe, text = 'Wednesday', font = ("Ariel, 30"))
    calendardayslabelwednesday.grid(row = 2, column = 2)
    calendardayslabelthursday = Label(calendarframe, text = 'Thursday', font = ("Ariel, 30"))
    calendardayslabelthursday.grid(row = 2, column = 3)
    calendardayslabelfriday = Label(calendarframe, text = 'Friday', font = ("Ariel, 30"))
    calendardayslabelfriday.grid(row = 2, column = 4)
    calendardayslabelsaturday = Label(calendarframe, text = 'Saturday', font = ("Ariel, 30"))
    calendardayslabelsaturday.grid(row = 2, column = 5)
    calendardayslabelsunday = Label(calendarframe, text = 'Sunday', font = ("Ariel, 30"))
